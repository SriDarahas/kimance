    ...
    <div className="font-[family-name:var(--font-inter)] bg-gray-50 text-gray-900 min-h-screen">
      ...
      <section className="max-w-4xl mx-auto px-6 -mt-12 pb-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Email Card */}
          <div className="bg-white rounded-2xl p-8 flex flex-col items-center text-center gap-5 border border-gray-100 shadow-sm hover:shadow-lg hover:border-[#6D28D9]/20 transition-all">
            <div className="w-16 h-16 bg-[#6D28D9]/10 rounded-full flex items-center justify-center">
              <span className="material-icons-outlined text-[#6D28D9] text-3xl">email</span>
            </div>
            <div>
              <h3 className="text-gray-900 text-xl font-bold mb-2">Email Us</h3>
              <a
                href="mailto:support@kimance.com"
                className="text-[#6D28D9] hover:text-[#5A24B3] text-base font-semibold transition-colors break-all"
              >
                support@kimance.com
              </a>
            </div>
          ...
          <div className="bg-white rounded-2xl p-8 flex flex-col items-center text-center gap-5 border border-gray-100 shadow-sm hover:shadow-lg hover:border-[#6D28D9]/20 transition-all">
            <div className="w-16 h-16 bg-[#6D28D9]/10 rounded-full flex items-center justify-center">
              <span className="material-icons-outlined text-[#6D28D9] text-3xl">phone</span>
            </div>
            <div>
              <h3 className="text-gray-900 text-xl font-bold mb-2">Call Us</h3>
              <a
                href="tel:+16132903200"
                className="text-[#6D28D9] hover:text-[#5A24B3] text-base font-semibold transition-colors"
              >
                (613) 290-3200
              </a>
            </div>
