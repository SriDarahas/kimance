      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {features.map((feature, index) => (
            <div 
              key={index} 
              className="feature-card group bg-violet-600 rounded-2xl p-8 border border-violet-500 hover:border-violet-400 transition-all duration-300 hover:shadow-xl hover:shadow-violet-900/30 hover:scale-[1.02] hover:bg-violet-500"
            >
